...
def plot_one_box(x, img, color=None, label=None, line_thickness=3):
    ...
    if label:
        ...
        c12=c1[0],c1[1]+3
        c22 = c12[0] + t_size[0], c12[1] - t_size[1] +3
        # print('c1',c1)
        # print('c2',c2)
        
        cv2.rectangle(img, c12, c22, color, -1, cv2.LINE_AA)  # filled
        # print('color',color)
        # print('label',label)
        cv2.putText(img, label, (c1[0], c1[1] - 2), 0, 0.68, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA) #可修改字体颜色
...
def plot_images(images, targets, paths=None, fname='images.png', names=None, max_size=640, max_subplots=16):
    ...
    for i, img in enumerate(images):
        ...
        # Image border
        cv2.rectangle(mosaic, (block_x, block_y), (block_x + w, block_y + h), (0, 0, 0), thickness=3)
